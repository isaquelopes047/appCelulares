...
let botaoBrirModal = document.querySelector('.funcionario')
async function getSetor() {

        functionsDefault.limpaTelaFuncionario()
    
        try {
            const urlConvertida = await conectaApi.filtrarDadoPorFuncionario();
